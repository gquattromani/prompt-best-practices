...
- **L1**: Non-English prompts. The skill should respond in the same language, but tier classification and rubric matching may degrade. If you improve non-English detection, re-verify A1–H10 still pass.
